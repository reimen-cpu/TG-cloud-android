<div style="display: flex; overflow-x: auto; gap: 15px; padding: 20px 0; justify-content: flex-start; align-items: center;">
  ...
  <img src="android/img/Captura%20de%20pantalla%202025-12-31%20190501.png" height="500" alt="Dashboard" style="border-radius: 10px; box-shadow: 0 4px 8px rgba(0,0,0,0.1);">
  <img src="android/img/photo_2026-01-03_04-26-09.jpg" height="500" alt="Cloud Gallery" style="border-radius: 10px; box-shadow: 0 4px 8px rgba(0,0,0,0.1);">
